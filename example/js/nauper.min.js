...
"use strict";Nauper.Question=function(t,i){var e=this,h=i.background,a=i.textbox.active,d=i.textbox.inactive,r=i.textbox.type,u=i.necessary,n=t.render,o=t.canvas,x=t.size,l=function(){h&&(o.style.backgroundImage='url("./data/images/backgrounds/'+h+'")')},s=function(){u===!0||void 0===u?e.type="choice":e.type="frame"},c=function(t,i,h){var r=.5*x.width-n.measureText(e.map[t].text).width/2,u=x.height*(h.y/x.height+.1);i?n.fillStyle=a.text:i||(n.fillStyle=d.text),n.fillText(e.map[t].text,r,u)},y=function(t,i,e){var h={xwidth:e.x+e.width,yheight:e.y+e.height};i?n.fillStyle=a.background:i||(n.fillStyle=d.background),"default"===r?n.fillRect(e.x,e.y,e.width,e.height):"rounded"===r&&(n.beginPath(),n.moveTo(e.x,e.y+e.radius),n.lineTo(e.x,h.yheight-e.radius),n.quadraticCurveTo(e.x,h.yheight,e.x+e.radius,h.yheight),n.lineTo(h.xwidth-e.radius,h.yheight),n.quadraticCurveTo(h.xwidth,h.yheight,h.xwidth,h.yheight-e.radius),n.lineTo(h.xwidth,e.y+e.radius),n.quadraticCurveTo(h.xwidth,e.y,h.xwidth-e.radius,e.y),n.lineTo(e.x+e.radius,e.y),n.quadraticCurveTo(e.x,e.y,e.x,e.y+e.radius),n.fill()),c(t,i,e)};this.map=i.map,this.map.length>1&&this.map.length<5?(s(),this.draw=function(){var t=.025*x.width,i=0,e=.2*x.height,h=.95*x.width,a=.05*x.height;n.clearRect(0,0,x.width,x.height),l(),this.map.forEach(function(d,r){i=(.25*r+.025)*x.height,y(r,!1,{x:t,y:i,height:e,width:h,radius:a})})}.bind(this)):t.nextElement()};
