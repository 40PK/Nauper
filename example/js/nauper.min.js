...
"use strict";Nauper.Redirect=function(n,e){var i={globalIndex:0,localIndex:0};this.engine=n,this.conf=putDefaults(i,e),this.draw=function(){this.engine.globalIndex=this.conf.globalIndex,this.engine.localIndex=this.conf.localIndex-1,this.engine.nextElement()}.bind(this)};
