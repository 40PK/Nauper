...
"use strict";Nauper.UI=function(e){this.engine=e,this.canvas=this.engine.canvas,this.render=this.engine.render,this.size=this.engine.size,this.menu=[],this.menuStyle={},this.currentMS=0,this.lastActive=void 0,this.menuOpened=!1},Nauper.UI.prototype.setBackground=function(e){e&&(this.canvas.style.backgroundImage="url(./data/images/backgrounds/"+e+")")},Nauper.UI.prototype.drawTextBox=function(e){var t=this,i={type:"default",color:"#fff",link:"",x:.025,y:.8,height:.18,width:.95,radius:.05,callback:function(){}},n=putDefaults(i,e),h=this.size.width*n.x,r=this.size.height*n.y,s=this.size.height*n.height,a=this.size.width*n.width,l=this.size.height*n.radius;this.render.fillStyle=n.color,"default"===n.type?this.render.fillRect(h,r,a,s):"rounded"===n.type?(this.render.beginPath(),this.render.moveTo(h,r+l),this.render.lineTo(h,r+s-l),this.render.quadraticCurveTo(h,r+s,h+l,r+s),this.render.lineTo(h+a-l,r+s),this.render.quadraticCurveTo(h+a,r+s,h+a,r+s-l),this.render.lineTo(h+a,r+l),this.render.quadraticCurveTo(h+a,r,h+a-l,r),this.render.lineTo(h+l,r),this.render.quadraticCurveTo(h,r,h,r+l),this.render.fill()):"image"===n.type&&!function(){var e=new Image;e.addEventListener("load",function(i){t.render.drawImage(e,h,r,a,s),n.callback&&n.callback(i)}),e.src=n.link}(),"image"!==n.type&&n.callback()},Nauper.UI.prototype.drawText=function(e){var t=this,i={text:"",align:"wrapped",color:"#000",x:.1,y:.85,width:.8},n=putDefaults(i,e),h=this.size.width*n.x,r=this.size.height*n.y,s=this.size.width*n.width;if(this.render.fillStyle=n.color,"wrapped"===n.align)!function(){var e=wrapText(t.render,n.text,t.render.font,s);e.result.forEach(function(i,n){t.render.fillText(i,h,r+e.height*n)})}();else if("center"===n.align){var a=getTextOffset(this.render,{width:this.canvas.width},n.text);this.render.fillText(n.text,a,r)}},Nauper.UI.prototype.process=function(e){var t=void 0,i=this.engine.elements[0][0];if(i!==this.engine.element||this.engine.firstPassed)if(this.menuOpened){for(var n=0;n<this.menu[this.currentMS].length;n+=1){var h=this.menu[this.currentMS][n];if(e.pageX>=h.x&&e.pageX<=h.x+h.width&&e.pageY>=h.y&&e.pageY<=h.y+h.height){h.callback();break}}this.menuOpened=!1,t="draw"}else e.pageX<50&&e.pageY<50?(this.drawMenu(),t=null):t="next";else t="draw",this.engine.firstPassed=!0;return t},Nauper.UI.prototype.move=function(e){if("choice"===this.engine.element.type){for(var t=e.pageX,i=e.pageY,n=!1,h=0;h<this.engine.element.map.length;h+=1){var r={x:.025*this.size.width,y:(.25*h+.025)*this.size.height,height:.2*this.size.height,width:.95*this.size.width};if(t>=r.x&&t<=r.x+r.width&&i>=r.y&&i<=r.y+r.height){this.engine.element.active=h,n=!0;break}}n||(this.engine.element.active=void 0),this.engine.element.active!==this.lastActive&&(this.lastActive=this.engine.element.active,this.engine.element.draw(!1))}},Nauper.UI.prototype.addMenuScreen=function(e){this.menu.push(e)},Nauper.UI.prototype.setMenuStyle=function(e){var t={mainbox:"default",maincolor:"#fff",smallbox:"default",smallcolor:"#eee",smallheight:.1,smallspace:.025,title:"#000",items:"#111"};this.menuStyle=putDefaults(t,e)},Nauper.UI.prototype.drawMenu=function(){var e=this,t=this.menu[this.currentMS].length,i=this.menuStyle.smallheight,n=this.menuStyle.smallspace,h={x:.25,y:.25,height:(i+n)*t+n,width:.5};this.drawTextBox({type:this.menuStyle.mainbox,color:this.menuStyle.maincolor,x:h.x,y:h.y,width:h.width,height:h.height,callback:function(){e.menu[e.currentMS].forEach(function(t,r){var s=.25+r*(i+n)+n,a=h.width-2*n;e.menu[e.currentMS][r].x=(.25+n)*e.size.width,e.menu[e.currentMS][r].y=s*e.size.height,e.menu[e.currentMS][r].width=a*e.size.width,e.menu[e.currentMS][r].height=e.menuStyle.smallheight*e.size.height,e.drawTextBox({type:e.menuStyle.smallbox,color:e.menuStyle.smallcolor,x:.25+n,y:s,height:e.menuStyle.smallheight,width:a,callback:function(){var i=getTextHeight(e.engine.font)/e.size.height,h=s+e.menuStyle.smallheight/2-i/2+n;e.drawText({align:"center",color:e.menuStyle.items,y:h,text:t.text})}})})}}),this.menuOpened=!0};
