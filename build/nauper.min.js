...
"use strict";Nauper.UI=function(e){this.engine=e,this.hideTextBox=function(){this.engine.sayBox.style.display="none"}.bind(this),this.showTextBox=function(){this.engine.sayBox.style.display="block"}.bind(this)},Nauper.UI.prototype.drawQuestion=function(e){var t=this;e.forEach(function(e,i){var n=document.createElement("div"),o=document.createElement("p");o.classList.add("inactiveQuestionText"),o.innerHTML=e.text,n.classList.add("inactiveQuestionBox"),n.appendChild(o),n.style.top=String(25*i)+"%",document.body.appendChild(n),n.addEventListener("mouseover",function(){n.classList.remove("inactiveQuestionBox"),n.classList.add("activeQuestionBox"),o.classList.remove("inactiveQuestionText"),o.classList.add("activeQuestionText")}),n.addEventListener("mouseout",function(){n.classList.remove("activeQuestionBox"),n.classList.add("inactiveQuestionBox"),o.classList.remove("activeQuestionText"),o.classList.add("inactiveQuestionText")}),n.addEventListener("click",function(){t.engine.redirect(e.address)})}),this.hideCharacters()},Nauper.UI.prototype.clearQuestion=function(){var e=document.querySelectorAll(".inactiveQuestionBox, .activeQuestionBox");e.forEach(function(e){e.remove()})},Nauper.UI.prototype.hideCharacters=function(){for(var e=document.querySelectorAll(".character"),t=0;t<e.length;t+=1)e[t].style.display="none"},Nauper.UI.prototype.setBackground=function(e){document.body.style.backgroundImage='url("'+e+'")'},Nauper.UI.prototype.fade=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"#000",t=this,i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"ease",n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:2e3,o=document.getElementsByTagName("html")[0];o.style.transitionDuration=String(n)+"ms",o.style.transitionTimingFunction=i,o.style.backgroundColor=e,o.style.opacity="0",setTimeout(function(){t.engine.click(),o.style.opacity="1"},n)};
"use strict";Nauper.Sound=function(n){this.engine=n};
"use strict";Nauper.Engine=function(){this.UI=new Nauper.UI(this),this.elements=[],this.notSkip=["say","drawQuestion","fade"],this.characters={},this.sayBox=document.getElementById("sayBox"),this.nameElem=document.getElementById("name"),this.textElem=document.getElementById("text"),this.globalIndex=0,this.localIndex=-1,this.click=function(){this.localIndex+=1,this.localIndex<this.elements[this.globalIndex].length&&(this.element=this.elements[this.globalIndex][this.localIndex],"fade"!==this.element.func&&(this.UI.clearQuestion(),this.UI.hideTextBox()),this.element.parent[this.element.func].apply(this.element.parent,this.element.arguments),this.notSkip.indexOf(this.element.func)===-1&&this.click())}.bind(this),this.clickListener=document.body.addEventListener("click",this.click)},Nauper.Engine.prototype.redirect=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0,t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;this.globalIndex=e,this.localIndex=t-1,"fade"!==this.elements[this.globalIndex][this.localIndex+1].func?this.UI.hideCharacters():setTimeout(this.UI.hideCharacters,this.elements[this.globalIndex][this.localIndex+1].arguments[2]||2e3)},Nauper.Engine.prototype.addLabel=function(e){e.length>0&&this.elements.push(e)},Nauper.Engine.prototype.start=function(){this.click()};
"use strict";Nauper.Character=function(t,e,i,s,a,r){this.engine=t,this.emotions=e,this.name=i,this.color=a,this.id=s,this.pos=r,this.engine.characters[this.id]=this,this.characterPos={0:"characterPos0",1:"characterPos1",2:"characterPos2",3:"characterPos3",center:"characterPosCenter"},this.currentEmotion=!1,this.setPos=function(t){this.clearPos(),this.image.classList.add(this.characterPos[t]),this.pos=t}.bind(this),this.clearPos=function(){var t=this;Object.getOwnPropertyNames(this.characterPos).forEach(function(e){t.image.classList.remove(t.characterPos[e])}),this.pos=!1}.bind(this),this.say=function(t){this.engine.nameElem.style.color=this.color,this.engine.nameElem.innerHTML=this.name,this.engine.textElem.innerHTML=t,this.engine.UI.showTextBox()}.bind(this),this.createImage(),this.setPos.call(this,r)},Nauper.Character.prototype.createImage=function(){var t=void 0;this.image=document.createElement("img"),this.image.id=this.id,this.image.classList.add("character"),this.image.classList.add(t),document.body.appendChild(this.image),this.image.style.display="none"},Nauper.Character.prototype.draw=function(t){var e=this;this.image.style.display="block",this.emotions[t]&&this.currentEmotion!==t&&!function(){e.image.src=e.emotions[t],e.currentEmotion=t;var i=function s(){var t=document.documentElement.offsetHeight,i=e.image.offsetHeight;i>t&&(e.image.style.top="0"),e.image.removeEventListener("load",s)};e.image.addEventListener("load",i)}()},Nauper.Character.prototype.hide=function(){this.image.style.display="none",this.image.src="",this.currentEmotion=!1};