function Engine(e){var n=0;nextElement=function(){n=Number(n)+1,console.log("new index - "+n),n==e.length?canvas.removeEventListener("click",nextElement):(e[n].draw(),"choice"==e[n].type&&(canvas.removeEventListener("click",nextElement),canvas.addEventListener("click",choice)))},choice=function(c){var t=c.pageY,i=3;t<.25*size.height?i=0:t<.5*size.height?i=1:t<.75*size.height&&(i=2),i<e[n].map.length&&(n=e[n].map[i].address,canvas.removeEventListener("click",choice),canvas.addEventListener("click",nextElement),e[n].draw())},this.start=function(){return"frame"==e[0].type?(console.log("it's a frame"),canvas.addEventListener("click",nextElement)):"choice"==e[1].type&&(console.log("it's a choice"),canvas.addEventListener("click",choice)),e[0].draw(),!0}}
