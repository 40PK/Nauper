...
"use strict";Nauper.Redirect=function(e,n){var i={globalIndex:0,localIndex:0};this.engine=e,this.conf=putDefaults(i,n),this.draw=function(){this.engine.globalIndex=this.conf.globalIndex,this.engine.localIndex=this.conf.localIndex-1,this.engine.nextElement(),this.engine.sound.process(this.engine.element.audio,this.engine.element.once)}.bind(this)};
