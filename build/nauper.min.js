...
"use strict";Nauper.Character=function(t,e,i,s,a,o){this.engine=t,this.emotions=e,this.name=i,this.color=a,this.id=s,this.pos=o,this.engine.characters[this.id]=this,this.characterPos={0:"characterPos0",1:"characterPos1",2:"characterPos2",3:"characterPos3",center:"characterPosCenter"},this.currentEmotion=!1,this.setPos=function(t){this.clearPos(),this.image.classList.add(this.characterPos[t]),this.pos=t}.bind(this),this.clearPos=function(){var t=this;Object.getOwnPropertyNames(this.characterPos).forEach(function(e){t.image.classList.remove(t.characterPos[e])}),this.pos=!1}.bind(this),this.say=function(t){this.engine.nameElem.style.color=this.color,this.engine.nameElem.innerHTML=this.name,this.engine.textElem.innerHTML=t,this.engine.UI.showTextBox()}.bind(this),this.createImage(),this.setPos.call(this,o)},Nauper.Character.prototype.createImage=function(){var t=void 0;this.image=document.createElement("img"),this.image.id=this.id,this.image.classList.add("character"),this.image.classList.add(t),document.body.appendChild(this.image),this.image.style.display="none"},Nauper.Character.prototype.draw=function(t){var e=this;this.image.style.display="block",this.emotions[t]&&this.currentEmotion!==t&&!function(){e.image.src=e.emotions[t],e.currentEmotion=t;var i=function s(){console.log(e.image.offsetHeight),console.log(document.documentElement.offsetHeight),e.image.offsetHeight>document.documentElement.offsetHeight&&e.image.classList.add("characterAlternative"),e.image.removeEventListener("load",s)};e.image.addEventListener("load",i)}()},Nauper.Character.prototype.hide=function(){this.image.style.display="none",this.image.src="",this.currentEmotion=!1};