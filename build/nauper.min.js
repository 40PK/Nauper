...
"use strict";var getTextHeight=function(t){var e=document.createElement("p"),n=0;return e.style.font=t,e.style.position="relative",e.style.zIndex="-1",e.innerHTML="Test",document.body.appendChild(e),n=e.offsetHeight,document.body.removeChild(e),n},wrapText=function(t,e,n,i){var r=e.split(" "),u="",o=getTextHeight(n),c=0,h=[];return r.forEach(function(e,n){c=""===u?t.measureText(e).width:t.measureText(u+" "+e).width,c>i?(h.push(u),u=e):c===i?(h.push(u+" "+e),u=""):c<i&&(u=u?u+" "+e:e,n+1===r.length&&h.push(u))}),{result:h,height:o}},getTextOffset=function(t,e,n){var i=t.measureText(n).width,r=.5*e.width,u=.5*i,o=r-u;return o},putDefaults=function(t,e){var n=Object.getOwnPropertyNames(t),i={};return n.forEach(function(n){void 0===e[n]?i[n]=t[n]:void 0!==e[n]&&(i[n]=e[n])}),i},copyObject=function(t){var e={};return e=putDefaults(t,{})},getWindowSize=function(){var t={width:document.documentElement.clientWidth,height:document.documentElement.clientHeight};return t.coff=t.width/t.height,t};
"use strict";Nauper.UI=function(e){this.engine=e,this.canvas=this.engine.canvas,this.render=this.engine.render,this.size=this.engine.size,this.menu=[],this.menuStyle={},this.currentMS=0,this.lastActive=void 0,this.menuOpened=!1,this.menuIconStyle={}},Nauper.UI.prototype.setBackground=function(e){e&&(this.canvas.style.backgroundImage="url(./data/images/backgrounds/"+e+")")},Nauper.UI.prototype.drawTextBox=function(e){var t=this,i={type:"default",color:"#fff",link:"",x:.025,y:.8,height:.18,width:.95,radius:.05,callback:function(){}},n=putDefaults(i,e),h=this.size.width*n.x,s=this.size.height*n.y,r=this.size.height*n.height,a=this.size.width*n.width,l=this.size.height*n.radius;this.render.fillStyle=n.color,"default"===n.type?this.render.fillRect(h,s,a,r):"rounded"===n.type?(this.render.beginPath(),this.render.moveTo(h,s+l),this.render.lineTo(h,s+r-l),this.render.quadraticCurveTo(h,s+r,h+l,s+r),this.render.lineTo(h+a-l,s+r),this.render.quadraticCurveTo(h+a,s+r,h+a,s+r-l),this.render.lineTo(h+a,s+l),this.render.quadraticCurveTo(h+a,s,h+a-l,s),this.render.lineTo(h+l,s),this.render.quadraticCurveTo(h,s,h,s+l),this.render.fill()):"image"===n.type&&!function(){var e=new Image;e.addEventListener("load",function(i){t.render.drawImage(e,h,s,a,r),n.callback&&n.callback(i)}),e.src=n.link}(),"image"!==n.type&&n.callback()},Nauper.UI.prototype.drawText=function(e){var t=this,i={text:"",align:"wrapped",color:"#000",x:.1,y:.85,width:.8},n=putDefaults(i,e),h=this.size.width*n.x,s=this.size.height*n.y,r=this.size.width*n.width;if(this.render.fillStyle=n.color,"wrapped"===n.align)!function(){var e=wrapText(t.render,n.text,t.render.font,r);e.result.forEach(function(i,n){t.render.fillText(i,h,s+e.height*n)})}();else if("center"===n.align){var a=getTextOffset(this.render,{width:this.canvas.width},n.text);this.render.fillText(n.text,a,s)}},Nauper.UI.prototype.checkMenuIconClick=function(e){var t=this.menuIconStyle.x*this.engine.size.width,i=this.menuIconStyle.y*this.engine.size.width,n=this.menuIconStyle.width*this.engine.size.width,h=this.menuIconStyle.height*this.engine.size.width;return e.pageX>=t&&e.pageY>=i&&e.pageX<=t+n&&e.pageY<=i+h},Nauper.UI.prototype.process=function(e){var t=void 0,i=this.engine.elements[0][0];if(i!==this.engine.element||this.engine.firstPassed)if(this.menuOpened){for(var n=0;n<this.menu[this.currentMS].length;n+=1){var h=this.menu[this.currentMS][n];if(e.pageX>=h.x&&e.pageX<=h.x+h.width&&e.pageY>=h.y&&e.pageY<=h.y+h.height){h.callback();break}}this.menuOpened=!1,t="draw"}else this.checkMenuIconClick(e)?(this.drawMenu(),t=null):t="next";else t="draw",this.engine.firstPassed=!0;return t},Nauper.UI.prototype.move=function(e){if("choice"===this.engine.element.type&&this.engine.ui.menuOpened===!1){for(var t=e.pageX,i=e.pageY,n=!1,h=0;h<this.engine.element.map.length;h+=1){var s={x:.025*this.engine.size.width,y:(.25*h+.025)*this.engine.size.height,height:.2*this.engine.size.height,width:.95*this.engine.size.width};if(t>=s.x&&t<=s.x+s.width&&i>=s.y&&i<=s.y+s.height){this.engine.element.active=h,n=!0;break}}n||(this.engine.element.active=void 0),this.engine.element.active!==this.lastActive&&(this.lastActive=this.engine.element.active,this.engine.element.draw(!1),this.engine.ui.drawMenuIcon())}},Nauper.UI.prototype.addMenuScreen=function(e){this.menu.push(e)},Nauper.UI.prototype.setMenuStyle=function(e){var t={mainbox:"default",maincolor:"#fff",smallbox:"default",smallcolor:"#eee",smallheight:.1,smallspace:.025,title:"#000",items:"#111"};this.menuStyle=putDefaults(t,e)},Nauper.UI.prototype.drawMenu=function(){var e=this,t=this.menu[this.currentMS].length,i=this.menuStyle.smallheight,n=this.menuStyle.smallspace,h={x:.125,height:(i+n)*t+n,width:.75};h.y=(1-h.height)/2,this.render.fillStyle="rgba(0, 0, 0, 0.7)",this.render.fillRect(0,0,this.engine.size.width,this.engine.size.height),this.drawTextBox({type:this.menuStyle.mainbox,color:this.menuStyle.maincolor,x:h.x,y:h.y,width:h.width,height:h.height,callback:function(){e.menu[e.currentMS].forEach(function(t,s){var r=h.y+s*(i+n)+n,a=h.width-2*n;e.menu[e.currentMS][s].x=(h.x+n)*e.size.width,e.menu[e.currentMS][s].y=r*e.size.height,e.menu[e.currentMS][s].width=a*e.size.width,e.menu[e.currentMS][s].height=e.menuStyle.smallheight*e.size.height,e.drawTextBox({type:e.menuStyle.smallbox,color:e.menuStyle.smallcolor,x:h.x+n,y:r,height:e.menuStyle.smallheight,width:a,callback:function(){var i=getTextHeight(e.engine.font)/e.size.height,h=r+e.menuStyle.smallheight/2-i/2+n;e.drawText({align:"center",color:e.menuStyle.items,y:h,text:t.text})}})})}}),this.menuOpened=!0},Nauper.UI.prototype.setMenuIconStyle=function(e){var t={type:"default",x:0,y:0,width:.05,height:.05,radius:.01,link:"",color:"#efefef"},i=putDefaults(t,e);i.height*=this.engine.size.coff,i.y*=this.engine.size.coff,this.menuIconStyle=i},Nauper.UI.prototype.drawMenuIcon=function(){this.drawTextBox(this.menuIconStyle)};
