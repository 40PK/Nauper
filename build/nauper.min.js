...
"use strict";Nauper.UI=function(e){this.engine=e,this.canvas=this.engine.canvas,this.render=this.engine.render,this.size=this.engine.size,this.menu=[],this.menuStyle={},this.currentMenuScreen=0,this.lastActive=void 0,this.menuOpened=!1},Nauper.UI.prototype.setBackground=function(e){e&&(this.canvas.style.backgroundImage="url(./data/images/backgrounds/"+e+")")},Nauper.UI.prototype.drawTextBox=function(e){var t=this,i={type:"default",color:"#fff",link:"",x:.025,y:.8,height:.18,width:.95,radius:.05,callback:function(){}},n=putDefaults(i,e),r=this.size.width*n.x,s=this.size.height*n.y,h=this.size.height*n.height,a=this.size.width*n.width,d=this.size.height*n.radius;this.render.fillStyle=n.color,"default"===n.type?this.render.fillRect(r,s,a,h):"rounded"===n.type?(this.render.beginPath(),this.render.moveTo(r,s+d),this.render.lineTo(r,s+h-d),this.render.quadraticCurveTo(r,s+h,r+d,s+h),this.render.lineTo(r+a-d,s+h),this.render.quadraticCurveTo(r+a,s+h,r+a,s+h-d),this.render.lineTo(r+a,s+d),this.render.quadraticCurveTo(r+a,s,r+a-d,s),this.render.lineTo(r+d,s),this.render.quadraticCurveTo(r,s,r,s+d),this.render.fill()):"image"===n.type&&!function(){var e=new Image;e.addEventListener("load",function(i){t.render.drawImage(e,r,s,a,h),n.callback&&n.callback(i)}),e.src=n.link}(),"image"!==n.type&&n.callback()},Nauper.UI.prototype.drawText=function(e){var t=this,i={text:"",align:"wrapped",color:"#000",x:.1,y:.85,width:.8},n=putDefaults(i,e),r=this.size.width*n.x,s=this.size.height*n.y,h=this.size.width*n.width;if(this.render.fillStyle=n.color,"wrapped"===n.align)!function(){var e=wrapText(t.render,n.text,t.render.font,h);e.result.forEach(function(i,n){t.render.fillText(i,r,s+e.height*n)})}();else if("center"===n.align){var a=getTextOffset(this.render,{width:this.canvas.width},n.text);this.render.fillText(n.text,a,s)}},Nauper.UI.prototype.process=function(e){var t=void 0,i=this.engine.elements[0][0];return i!==this.engine.element||this.engine.firstPassed?this.menuOpened?(this.menuOpened=!1,t="draw"):e.pageX<50&&e.pageY<50?(this.drawMenu(),t=null):t="next":(t="draw",this.engine.firstPassed=!0),t},Nauper.UI.prototype.move=function(e){if("choice"===this.engine.element.type){for(var t=e.pageX,i=e.pageY,n=!1,r=0;r<this.engine.element.map.length;r+=1){var s={x:.025*this.size.width,y:(.25*r+.025)*this.size.height,height:.2*this.size.height,width:.95*this.size.width};if(t>=s.x&&t<=s.x+s.width&&i>=s.y&&i<=s.y+s.height){this.engine.element.active=r,n=!0;break}}n||(this.engine.element.active=void 0),this.engine.element.active!==this.lastActive&&(this.lastActive=this.engine.element.active,this.engine.element.draw(!1))}},Nauper.UI.prototype.addMenuScreen=function(e){e.name&&0!==e.items.length&&this.menu.push(e)},Nauper.UI.prototype.setMenuStyle=function(e){var t={mainbox:"default",mainboxcolor:"#fff",littlebox:"default",littleboxcolor:"#eee",title:"#000",items:"#111"};this.menuStyle=putDefaults(t,e)},Nauper.UI.prototype.drawMenu=function(){this.drawTextBox({type:this.menuStyle.mainbox,color:this.menuStyle.mainboxcolor,x:.25,y:.25,width:.5,height:.5}),this.menuOpened=!0};
