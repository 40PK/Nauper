...
"use strict";Nauper.UI=function(e){this.engine=e,this.canvas=this.engine.canvas,this.render=this.engine.render,this.size=this.engine.size,this.menu=[],this.menuStyle={},this.currentMenuScreen=0,this.lastActive=void 0},Nauper.UI.prototype.setBackground=function(e){e&&(this.canvas.style.backgroundImage="url(./data/images/backgrounds/"+e+")")},Nauper.UI.prototype.drawTextBox=function(e){var t=this,i={type:"default",color:"#fff",link:"",x:.025,y:.8,height:.18,width:.95,radius:.05,callback:function(){}},n=putDefaults(i,e),r=this.size.width*n.x,s=this.size.height*n.y,h=this.size.height*n.height,a=this.size.width*n.width,l=this.size.height*n.radius;this.render.fillStyle=n.color,"default"===n.type?this.render.fillRect(r,s,a,h):"rounded"===n.type?(this.render.beginPath(),this.render.moveTo(r,s+l),this.render.lineTo(r,s+h-l),this.render.quadraticCurveTo(r,s+h,r+l,s+h),this.render.lineTo(r+a-l,s+h),this.render.quadraticCurveTo(r+a,s+h,r+a,s+h-l),this.render.lineTo(r+a,s+l),this.render.quadraticCurveTo(r+a,s,r+a-l,s),this.render.lineTo(r+l,s),this.render.quadraticCurveTo(r,s,r,s+l),this.render.fill()):"image"===n.type&&!function(){var e=new Image;e.addEventListener("load",function(i){t.render.drawImage(e,r,s,a,h),n.callback&&n.callback(i)}),e.src=n.link}(),"image"!==n.type&&n.callback()},Nauper.UI.prototype.drawText=function(e){var t=this,i={text:"",align:"wrapped",color:"#000",x:.1,y:.85,width:.8},n=putDefaults(i,e),r=this.size.width*n.x,s=this.size.height*n.y,h=this.size.width*n.width;if(this.render.fillStyle=n.color,"wrapped"===n.align)!function(){var e=wrapText(t.render,n.text,t.render.font,h);e.result.forEach(function(i,n){t.render.fillText(i,r,s+e.height*n)})}();else if("center"===n.align){var a=getTextOffset(this.render,{width:this.canvas.width},n.text);this.render.fillText(n.text,a,s)}},Nauper.UI.prototype.process=function(e){var t=void 0,i=this.engine.elements[0][0];return i!==this.engine.element||this.engine.firstPassed?e&&(t="next"):(t="draw",this.engine.firstPassed=!0),t},Nauper.UI.prototype.move=function(e){if("choice"===this.engine.element.type){for(var t=e.pageX,i=e.pageY,n=!1,r=0;r<this.engine.element.map.length;r+=1){var s={x:.025*this.size.width,y:(.25*r+.025)*this.size.height,height:.2*this.size.height,width:.95*this.size.width};if(t>=s.x&&t<=s.x+s.width&&i>=s.y&&i<=s.y+s.height){this.engine.element.active=r,n=!0;break}}n||(this.engine.element.active=void 0),this.engine.element.active!==this.lastActive&&(this.lastActive=this.engine.element.active,this.engine.element.draw(!1))}},Nauper.UI.prototype.addMenuScreen=function(e){e.name&&0!==e.items.length&&this.menu.push(e)},Nauper.UI.prototype.setMenuStyle=function(e){var t={mainbox:"default",mainboxcolor:"#fff",littlebox:"default",littleboxcolor:"#eee",title:"#000",items:"#111"};this.menuStyle=putDefaults(t,e)};
"use strict";Nauper.Sound=function(t){this.engine=t,this.audio=this.engine.audio,this.audio.volume=this.engine.audioVolume,this.repeating=!1,this.repeatend=function(){this.audio.play(),this.repeating=!0}.bind(this),this.stopend=function e(){this.stop(),this.audio.removeEventListener("ended",e)}.bind(this)},Nauper.Sound.prototype.play=function(t,e){this.audio.src="/data/sounds/"+t,this.audio.play(),e?this.audio.addEventListener("ended",this.stopend):e||this.audio.addEventListener("ended",this.repeatend)},Nauper.Sound.prototype.pause=function(){this.audio.pause()},Nauper.Sound.prototype.stop=function(){this.pause(),this.repeating&&(this.audio.removeEventListener("ended",this.repeatend),this.repeating=!1),this.audio.src=""},Nauper.Sound.prototype.process=function(t,e){var i="/data/sounds/"+t,s=this.audio.src.substr(-i.length,i.length);console.log(t,e,i,s),void 0!==t&&i!==s&&(this.stop(),t&&this.play(t,e))};
"use strict";Nauper.Engine=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];this.font=e.font,this.audio=document.getElementById("audio"),this.canvas=document.getElementById("canvas"),this.render=this.canvas.getContext("2d"),this.size=getWindowSize(),this.ui=new Nauper.UI(this),this.audioVolume=.5,this.sound=new Nauper.Sound(this),this.canvas.width=this.size.width,this.canvas.height=this.size.height,this.render.font=this.font,this.firstPassed=!1,this.element=null,this.elements=t,this.globalIndex=0,this.localIndex=0,this.clickType=null,this.elementProcessor=function(e){var t=this.ui.process(e);"redraw"===t?this.element.draw():"next"===t?(this.click(e),this.sound.process(this.element.audio,this.element.once)):"draw"===t&&(this.element.draw(),this.sound.process(this.element.audio,this.element.once))}.bind(this),this.resize=function(){this.size=getWindowSize(),this.canvas.width=this.size.width,this.canvas.height=this.size.height,this.element.draw()}.bind(this),this.move=function(e){this.ui.move(e)}.bind(this),this.canvas.addEventListener("click",this.elementProcessor,!1),window.addEventListener("resize",this.resize,!1),window.addEventListener("mousemove",this.move,!1)},Nauper.Engine.prototype.click=function(e){this.clickType&&this[this.clickType].call(this,e)},Nauper.Engine.prototype.choice=function(e){var t=this,i=e.pageX,s=e.pageY;this.element.map.forEach(function(e,n){var h={x:.025*t.size.width,y:(.25*n+.025)*t.size.height,height:.2*t.size.height,width:.95*t.size.width};i>=h.x&&i<=h.x+h.width&&s>=h.y&&s<=h.y+h.height&&(e.address!==!1&&(t.globalIndex=e.address,t.localIndex=-1),t.nextElement())})},Nauper.Engine.prototype.nextElement=function(){this.localIndex=Number(this.localIndex)+1,this.localIndex===this.elements[this.globalIndex].length?this.clickType=null:(this.element=this.elements[this.globalIndex][this.localIndex],this.element.draw.call(null,this),"choice"===this.element.type&&(this.element.necessary||void 0===this.element.necessary)?this.clickType="choice":this.clickType="nextElement")},Nauper.Engine.prototype.start=function(){return"frame"===this.elements[0][0].type?this.clickType="nextElement":"choice"===this.elements[0][0].type&&(this.clickType="choice"),this.element=this.elements[0][0],this.elementProcessor({pageX:-1,pageY:-1}),!0},Nauper.Engine.prototype.addScene=function(e){this.elements.push(e)};
